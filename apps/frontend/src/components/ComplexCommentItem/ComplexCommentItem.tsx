...
export default function ComplexCommentItem({ comment }: Props) {
    ...
    return (
        <li className="complex-comments__item">
            <Avatar
            ...
            <div className="complex-comments__body">
                <div className="complex-comments__meta">
                    <span className="complex-comments__author">
                        <UserLink
                            username={author?.nickname ?? "неизвестный"}
                        />
                    </span>

                    <span className="complex-comments__date">
                ...
                {
                    isEditing ? (
                        <div className="complex-comments__edit">
                            <Textarea
                                id={`complex-comment-edit-${comment.id}`}
                                label="Комментарий"
                                value={text}
                        ...
                        <>
                            <p className="complex-comments__text">
...

                            {
                                isOwnComment && (
                                    <div className="complex-comments__owner-actions">
                                        ...
                                        <button
                                            type="button"
                                            className="complex-comments__action complex-comments__action--danger"
